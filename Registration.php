...
<? 
	...
	if( $_REQUEST['CandidateRegistration'] == "Register Now" ) {
	include("Regstrn.php");
	} 
...
<script type="text/javascript">funDate(1945,2030);</script></select>
</td></tr>
...
<tr><td></td><td><a href="mangfrm.php" target="_parent"><img src="images/back.jpg" border="0"></a></td><td colspan="2" align="right"><input type="submit" name="CandidateRegistration" value="Register Now" onClick="return validateRegForm();"/>&nbsp;&nbsp;<input type="reset" name="reset" value="Re-Set" /></td></tr>
</table>
</form>
