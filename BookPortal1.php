...
if( $i == 1 ){  $i = 2 ;  $clr = "FAEBD7";
 ...
 echo "<tr bgcolor=\"$clr\"><td align=\"right\"><img src=\"images/serial.jpg\" width=\"20\" height=\"20\"></td><td align='right'>".$k++ ." </td><td align='right'><input type=\"checkbox\" name=\"books\" value=\"$db_ID\"></td><td>$db_book</td><td>$db_author</td><td>$db_publish</td><td align='left'>$db_dept<td>$db_edition</td><td align='right'>$db_price</td><td align='right'>$T_Books</td><td align='right'>$AB</td><td align='right'>$IB</td><td align='center'><a href=BPopen.php?action=Open+Book&ID=".$row['Book_ID']." title=\" Open the list of $db_book books\" >open</a></tr> ";
