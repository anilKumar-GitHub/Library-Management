...
echo "<tr bgcolor=\"$clr\"><td align=\"right\"><img src=\"images/serial.jpg\" width=\"20\" height=\"20\"></td><td align='right'>". $k++ ." </td><td align='right'><input type=\"checkbox\" name=\"books\" value='$db_ID'></td><td>$db_ID</td><td>$db_book</td><td>$db_author</td><td>$db_publish</td><td >$branch</td><td>$edt</td><td>$db_price</td><td><a href=issueprocess2.php?action=issueLink&BNO=$db_ID title=\" Open the list of $db_book books\" >Issue</a></td></tr> ";
...
<tr><td colspan="2"><a href="searchEngin.php"><img src="images/back.jpg" border="0"></a></td><td colspan="10"><input type="hidden" name="hideBook" size="500">
